 ...
 * @author hEAT
 */
public class RandomAlgorithm extends AlgorithmProduct {
    ...
    protected final String algorithm = "RANDOM ALGORITHM";

    public RandomAlgorithm(List<Diver> divers, List<DiveDate> dives, HashMap<DiveDate, ArrayList<Diver>> diversInDates, long seed, String resultsDat, boolean sout, List<DiveAgency> diveAgencies) {
    ...
    public void randomSort() {
        ...
        for (DiveDate dejt : dives) {
            ...
            Collections.shuffle(listaDivera, new Random(seed));
